...
Phase 1 and Phase 2 are completed development milestones. Phase 3 Spatial Intelligence is in progress with N1–N6's canonical place, offline-first Map, provider-independent journey foundation, installed-region lifecycle, reviewed provider/list/coverage workflows and trustworthy local walking journeys delivered, together with X1's Gold Coast prerequisite evidence; public transport, Calendar materialisation and later slices remain planned. Detailed boundaries belong in the phase documents and [Roadmap](../ROADMAP.md), not glossary definitions.
