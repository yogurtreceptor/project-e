...
Phase 2 is the planned operational time and deterministic-automation foundation: temporal semantics, Events, calendar projections, Tasks, reminder policies, attention management, a lightweight local scheduler and deterministic rules. It remains AI-independent. AI-assisted interpretation remains a later phase and must enter through the same platform capability and audit boundaries. See [the Phase 2 plan](phase_2_plan.md) for the current planned scope.
