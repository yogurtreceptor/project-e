...
The current platform has canonical Locations with address and role-based geometry assertion history, explicit containment Relationships, a deterministic representative-point Map projection, optional OSM/Nominatim form enrichment, and the Phase 2 Event/Calendar/reminder/Inbox/scheduler foundation. It does not yet have Map 2.0, packs, offline search/routing, transit routing, mobility profiles, routing policies or journey groups.
