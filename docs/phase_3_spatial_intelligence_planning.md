...
**Phase 3 is in progress, with implementation complete through N4, the X1 prerequisite evidence complete and N5A delivered.** N1, N2 and N3 were delivered and verified on 2026-08-05; X1 and N4 were completed on 2026-08-07; N5's reviewed-promotion and portable-list slice was completed on 2026-08-08. N5 coverage recommendations, N6–N9 and L1–L3 remain planned, not delivered. Dated **Complete:** entries are delivered contracts or evidence; all other outcomes, ordering and candidates remain planning that does not authorise implementation or claim those capabilities exist.

| Slice | Delivery status | Boundary |
| --- | --- | --- |
| N1 · Canonical place and endpoint foundation | **Complete · 2026-08-05** | Canonical address/geometry assertions, provenance and Location containment. |
| N2 · Map 2.0A canonical workspace | **Complete · 2026-08-05** | Offline-first canonical map/search/sidebar/layer/state workspace. |
| N3 · Provider-independent journey contract | **Complete · 2026-08-05** | Journey request/result/failure, profile/policy identity, fingerprint and disposable-cache foundation. |
| X1 · Gold Coast evidence spike | **Complete · 2026-08-07** | Reproducible evidence and capability-specific front-runners; no production provider, pack or adapter installed. |
| N4 · First installed-region Map slice | **Complete · 2026-08-07** | Verified Gold Coast normal local map/search/context plus atomic pack lifecycle. |
| N5 · Map 2.0B review, bookmarks and coverage | **In progress · N5A complete 2026-08-08** | Reviewed provider saving/reconciliation and portable favourites/named lists are delivered; contextual coverage recommendations remain planned. |
| N6–N9 and L1–L3 | **Planned · not implemented** | Production journeys, Calendar materialisation and later spatial capabilities. |

The detailed delivery record is the numbered **Complete:** ledger under [Completion and expansion workspace](#completion-and-expansion-workspace).
...
The current platform has canonical Locations with address and role-based geometry assertion history, explicit containment Relationships, Map 2.0 with canonical overlays plus one installed Gold Coast normal local map/search/context pack, explicitly requested Nominatim search, reviewed duplicate-aware provider promotion, portable external favourites/named lists, the provider-independent journey request/result/failure seam with durable mobility-profile/routing-policy identity and a disposable cache boundary, and the Phase 2 Event/Calendar/reminder/Inbox/scheduler foundation. X1 supplies reproducible Gold Coast source/build measurements and capability-specific candidates for later routing slices. The application still has no contextual adjoining-region coverage recommender, production routing adapter, calculated production route, reviewed production profile/policy value or journey group.
...
## Research baseline and X1 outcome
...
The component contract after X1 is:
...
| Offline basemap | N4 adopts tilemaker-derived vector MBTiles plus vendored MapLibre GL JS; PMTiles remains a challenger if measured serving/lifecycle costs justify change |
| Local search | N4 adopts a fixed read-only derived SQLite index over visible vector labels and static GTFS stops; MOTIS remains the N7 transit/routing choice and a later richer-geocoding challenger |
...
The Gold Coast spike created the official 15 km buffered boundary route, verified one portable source manifest, retained SEQ GTFS separately, built fingerprinted tile and graph evidence, and tested internal/boundary routes. It also showed that `complete_ways` extraction and MOTIS import each peak around 3.2 GiB on the measured host. N4 therefore installs a prebuilt verified 18.3 MB archive whose validated members occupy about 24 MB, caps uploads at 512 MB and extracted staging at 2 GiB, and requires extracted bytes plus a safety reserve before staging. Later Logan/Brisbane packs still require their own authorised slice and use the same source-snapshot contract; compatible routing source packs rebuild one union graph rather than overlay separately built engine graphs. The full X1 measurement and recovery record is [Phase 3 X1 Gold Coast Spatial Evidence](reviews/phase_3_x1_spatial_evidence.md).
...
| Candidate | Position |
| --- | --- |
| [Valhalla](https://valhalla.github.io/valhalla/api/) | **Street-routing front-runner:** measured compact Gold Coast graph, explicit walking speed, all three street modes and low loopback latency. MOTIS is the street challenger if native-Windows packaging, snap/admin/timezone inputs or policy translation fails. |
| [MOTIS](https://github.com/motis-project/motis) | **Static-transit front-runner and street challenger:** measured OSM+current GTFS import, depart/arrive transit, geocoding/tiles and native Windows startup. OpenTripPlanner becomes the transit challenger only for a concrete N7 semantic failure. |
...
### Delivered · N1–N3 complete

#### N1. Canonical place and endpoint foundation — Complete 2026-08-05
...
Reconsider the coordinate encoding only when an authorised spatial engine needs measured query/index operations that compact JSON cannot serve; reconsider single active parent only for a concrete real place that cannot be represented by other Relationships without ambiguous hierarchy; and extend N5A's explicit provider reconciliation into automatic or provider-specialized matching only with measured false-match/stable-identity evidence.

#### N2. Map 2.0A canonical workspace — Complete 2026-08-05
...
#### N3. Provider-independent journey contract — Complete 2026-08-05
...
Focused fixture, endpoint, profile/policy, fingerprint, cache, failure, fresh-schema, representative-upgrade and portability tests plus the 325-test full suite passed. X1 subsequently exposed provider bounds, snap and stage details that fit the existing contract without weakening meaning; specialize profile/policy definitions only from measured N6/N7/N9 evidence, and change the cache store or bounds only after representative size/latency/retention measurements. At this N3 checkpoint no routing engine, pack/provider choice, X1/N4 work or Calendar materialisation had begun.

### Delivered evidence · X1 complete

#### X1. Gold Coast pack, renderer/search and routing evidence spike — Complete 2026-08-07
...
##### X1 evidence and D01/D06–D09/D11/D12/D14–D18 direction · 2026-08-07

One fixed Gold Coast evidence package verified the official boundary, a dated Queensland OSM snapshot and current SEQ GTFS by SHA-256 under ignored staging. Standard-library tooling inventories sources/builds, probes loopback services and serves read-only MBTiles without joining the application runtime. The same 15 km OSM extract produced a 15.9 MB tilemaker MBTiles archive, a 46.0 MB Valhalla street graph and a 231.4 MB MOTIS OSM/GTFS build. Peak builds were about 403 MiB for tiles, 474 MiB for Valhalla and 3.2 GiB for both reference-complete extraction and MOTIS import; native Windows MOTIS startup and Linux/WSL2 loopback cold starts were also verified.

At the X1 checkpoint, the evidence selected capability-specific front-runners rather than one provider: tilemaker/MBTiles plus vendored MapLibre for N4 display, MOTIS geocoding for N4 installed search, Valhalla for N6 street routing and MOTIS for N7 static transit. They were reversible starting positions rather than installed architecture. N4 subsequently adopted the display pair and invoked X1's explicit capability-separation/import-resource trigger to choose the derived SQLite search challenger. MOTIS's coupled import peak/default direct-route bound and absent explicit Wait legs, Valhalla's distant out-of-coverage snapping and missing admin/timezone side data, and native Valhalla Windows packaging remain N6/N7 obligations and reconsideration triggers. No N3 contract change was needed. Licences, attribution, mutable-source retention/reacquisition, last-known-good rollback and exact tool/source/build digests are recorded in [the X1 evidence report](reviews/phase_3_x1_spatial_evidence.md).

### Delivered implementation · N4 complete

#### N4. First installed-region Map slice — Complete 2026-08-07
...
##### N4 implementation and D01/D06–D08/D14/D16/D18 resolution · 2026-08-07

N4 fixes `project-e-spatial-pack` schema version 1 as a bounded ZIP containing one strict manifest, vector `basemap.mbtiles`, read-only `search.sqlite3` and `coverage.geojson`. Inspection accepts exactly those members, rejects links/traversal/duplicates/unknown members, checks declared sizes and SHA-256 digests, available staging space, SQLite identities/schemas/integrity, tile zoom/bounds and geometry bounds, and leaves the active pack unchanged. Activation moves a validated immutable version into ignored runtime storage and atomically replaces a small active pointer; updates retain the previous validated version for two-way rollback. This first slice deliberately permits one active region, requires explicit removal before a different region, and audits activation, rollback and confirmed removal without making pack bytes part of canonical portability.

The installed Gold Coast version contains 1,431 vector tiles and 38,180 derived search features from visible OSM vector labels and static Translink stops. X1's explicit capability-separation trigger was met: the fixed SQLite index replaces MOTIS geocoding for N4 because ordinary installed search does not justify coupling to MOTIS's 231.4 MB build, native process and approximately 3.2 GiB import. Representative repeated search averaged about 11.6 ms on the measured host. MOTIS remains the N7 static-transit front-runner and may challenge the small index only if a measured richer-geocoding need cannot fit this format.

Map 2.0 now composes the existing canonical DOM overlay/text alternative with vendored MapLibre GL JS 6.2.0 and same-origin MBTiles, official coverage and static transit context. Normal-map, general-place and public-transport controls begin visible and persist locally; ranked search remains stable through pan/zoom; provider clicks are inspection-only; blank space does nothing; coordinates outside coverage remain visible over the coordinate grid. Coverage, version, production date, source versions, limitations and required attribution are visible in Map and Spatial Packs. With no pack or a renderer/search failure, canonical Map operation remains available without an online fallback.

Lifecycle fixtures proved corrupt/checksum/path/disk/different-region rejection, failed-pointer last-known-good retention, update, two-way rollback, confirmed removal and canonical-data independence. The real Gold Coast pack was built, validated and activated under ignored runtime storage. The 340-test full suite, compilation, JavaScript syntax check and temporary-port headless Edge visual/keyboard review passed after catching and correcting one renderer style expression: six local tiles plus local coverage/transit loaded, every observed page request stayed same-origin, provider context was clickable, transit toggled, keyboard pan persisted and the wide page had no horizontal overflow. The desktop computer-use bridge could not attach to the WSL workspace, so the browser check used the bundled Edge/Playwright fallback.

### Next · N5 in progress; N6 onward not implemented

#### N5. Map 2.0B review, bookmarks and coverage · in progress
...
- **Complete: N5A · Reviewed promotion and portable lists (2026-08-08).** Installed search, rendered provider context and explicitly requested Nominatim selections now expose separate reviewed **Save as Location** and list actions. Promotion revalidates active-pack identity, reviews exact provider/name/address/100-metre point matches and requires an explicit new/existing choice; using an existing Location adds only the accepted provider reference, while creating a new Location records source-reported structured address/point assertions and an audited neutral reference. `map_feature_lists` and `map_feature_list_memberships` store durable favourites/named-list identity, provider/feature identity and a user-owned label without copying coordinates, provider version or pack facts. Current provider facts resolve on revisit; pack removal/version disappearance remains visibly unavailable without silently reassigning membership, and online revisit stays explicit. Named-list create, revisit, JSON export, item removal, confirmed clear and whole-platform portability are delivered through migration `20260808_35_map_feature_lists`. Two-version disappearance/reconciliation, non-mutation, duplicate linking, pack-independent list retention, fresh/upgrade/portability/HTTP tests, all 346 tests, compilation, bundled-Node JavaScript syntax and same-origin temporary-port Edge review/promotion/bookmark/revisit/keyboard/900-pixel reflow checks passed. Contextual bordering-suburb/adjoining-LGA recommendations remain pending measured scope/size/source evidence, so N5 is not complete.
...
| --- | --- | --- |
| D01, D06, D16, D18 | **First-region lifecycle resolved by N4.** Schema-version-1 manifest/archive, strict bounded inspection, ignored immutable versions, disk reserve, atomic active pointer, failed-update retention, rollback, one-region refusal and canonical-independent removal are delivered for Gold Coast. Later adjoining-region/union/routing-source packaging remains for N5/N6 evidence rather than being generalized early. | Gold Coast first; portable verified packs and disposable derived builds; one active region in this slice; route/feature coordinates survive missing map coverage; later coverage recommendations never auto-install or silently claim absent routing capability. |
...
| D07, D08, D14 | **Normal local map/search/context resolved by N4.** tilemaker MBTiles and vendored MapLibre render the verified Gold Coast map from same-origin resources; a derived read-only SQLite index supplies installed search; general-place/transit context, provider inspection, visible coverage/freshness/attribution and canonical degraded operation passed browser/lifecycle proof. Satellite/terrain, specialist overlays, current-location implementation/consent and online connection packaging remain later slices. | Search results never rerun on pan while enabled layers load visible features; persistent accessible canonical selection/sidebar and complete text alternative remain; blank clicks do not pin; clickable provider features never mutate; current location remains device-first one-shot later work with no tracking or hidden query logging. |
| D19 | **N2/N4/N5A Map-state subset resolved.** Last viewport, canonical and installed context-layer visibility, sidebar navigation, shared-place grouping, portable favourites/named lists and provider-version disappearance/reconciliation are delivered. Bounded recent-search/selection retention and contextual coverage recommendations remain for later N5/L1 evidence. | Normal base, canonical Locations and available general-place/transit features begin visible; unavailable/specialist layers remain honest and choices persist locally. External bookmarks need no canonical promotion; user membership is portable while provider facts are reacquired; no reusable saved journey. |
| D09, D12, D17 | **N3 foundation resolved; X1 engine direction measured.** Valhalla is the N6 street front-runner and MOTIS the N7 static-transit front-runner/street challenger. Distant snap bounds, admin/timezone and native-Windows Valhalla packaging, explicit Wait derivation, empty/coverage/no-route separation, malformed/update handling and station/service-day semantics remain N6/N7 acceptance work. | Adapters declare capability and return normalised stages, distance/time meanings, provenance and typed failures; providers remain capability-specific replaceable calculators; static timetable remains default. |
...
| D11, D15 | **Identity/refusal foundation resolved by N3; X1 speed translation measured.** MOTIS and Valhalla accept explicit walking speed while stable Walk/profile identity stays Project E-owned. Preset values, Sprint/distance applicability, specialized policy mappings and accessibility/environmental evidence still need user measurements and N6/N9 worked conflicts; unproven candidate flags remain unsupported. | Stable Walk/Cycle/Drive/Public transport modes normalise to mode-specific stages; pace variants remain Walk profiles; journey enable/disable selects the active policies, then remaining hard, specific, soft and provider-default rules apply in order; conflicts are surfaced; no silent learning or unsupported claims. |
...
1. **Complete: N1 · Canonical place and endpoint foundation (2026-08-05).** Resolved D02–D05 with normalized physical/postal/delivery address assertions; validated role-based WGS84 Point/LineString/MultiLineString/Polygon/MultiPolygon geometry assertions; assertion-level confidence, accuracy and source snapshots; removable neutral provider references; and single-active-parent, cycle-safe `contains_location` Relationships. Migration `20260805_33_canonical_place_foundation` preserves valid flattened address/point values and provenance while refusing silent coordinate loss. Current forms, Location detail and Map deterministically project the preferred current physical address/representative point, retaining replacements as history and inheriting parent address for display only. Fresh-schema, representative-upgrade, behavioral, portability and full-suite tests, compilation and a temporary-port create/detail/Map smoke passed. At this N1 checkpoint no N2 renderer, pack, search, routing or provider architecture had been selected; N2 and N3 were subsequently delivered as entries 2 and 3.
2. **Complete: N2 · Map 2.0A canonical workspace (2026-08-05).** Resolved D07/D08/D14 and the Map-state subset of D19 with a map-dominant, browser-native canonical coordinate canvas; stable canonical-first name/address/coordinate and explicitly requested current-provider search; one-pin shared-place grouping; persistent accessible selection, results/details/back and complete text equivalent; deterministic local layer controls; failure-tolerant local viewport/layer/sidebar state; and a bounded local viewport endpoint with stale-request abort/discard. Automatic Leaflet CDN and OSM tile dependence is removed; unavailable map/provider layers remain explained, and Nominatim is off by default, query-only, attributed, replaceable and honestly degradable. Dense fictional, behavioral, accessibility, degraded-network, HTTP/state/regression, full-suite/compile and temporary-port Edge wide/constrained/keyboard/visual checks passed. At this N2 checkpoint N3 had not begun; N3 was subsequently delivered as entry 3. No pack/tile/search/routing architecture, current-location workflow or later provider choice was begun.
3. **Complete: N3 · Provider-independent journey contract (2026-08-05).** Resolved the foundation portions of D09–D11/D15 with deliberate canonical Location/access-point resolution; strict versioned capability declarations; provider-independent request, normalized stage/result, distance/time, provenance/explanation and typed failure contracts; audited durable user-owned mobility-profile/routing-policy identity; full semantic dependency fingerprints; and a bounded clearable fresh/stale/miss cache outside personal data. Deterministic fictional adapters proved ambiguity, unsupported requirements, partial coverage, no-route/provider-failure separation, contiguous profile limits, policy conflict/no-compliant-route, cache corruption and provider replacement while every requested profile/policy remains explicit. Migration, recovery, focused regression and 325-test full-suite checks passed. At this N3 checkpoint no engine/provider/pack was selected or integrated, X1/N4 had not begun and no Calendar Event or journey group was created.
4. **Complete: X1 · Gold Coast spatial evidence (2026-08-07).** Verified fixed official boundary, dated OSM and current SEQ GTFS inputs under ignored staging; reproduced a buffered extract, vector-tile archive, Valhalla street graph and MOTIS search/street/static-transit build; measured size, time, memory, cold start, loopback latency, representative modes/profiles/transit/boundary failures and native Windows MOTIS startup; and recorded exact licences, attribution, reacquisition, rollback and unsupported semantic mappings. Capability-specific front-runners are tilemaker/MBTiles plus vendored MapLibre for N4 display, MOTIS for N4 search and N7 static transit, and Valhalla for N6 street routing, each with an explicit challenger and trigger. The committed evidence harness, five focused tests, 330-test full suite, compilation and loopback tile-server smoke passed without changing application runtime, canonical data, Event lifecycle, production provider or pack.
5. **Complete: N4 · First installed-region Map slice (2026-08-07).** Resolved D01/D06–D08/D14/D16/D18 and extended the Map-state portion of D19 with a strict versioned spatial-pack manifest/archive; inspect/verify/stage/validate/atomic-activate/update/two-way-rollback/confirmed-remove lifecycle; last-known-good and one-active-region rules; visible source, coverage, version, freshness, limitations and attribution; and canonical-data-independent ignored storage. The verified Gold Coast pack supplies 1,431 tilemaker vector tiles and a fixed 38,180-feature derived SQLite search/static-transit index, rendered by vendored MapLibre GL JS 6.2.0 under the existing canonical DOM/text overlay. The explicit X1 capability-separation trigger replaced MOTIS search for this slice while preserving MOTIS as N7's transit front-runner. Corruption/path/disk/failure/update/rollback/removal fixtures, 340 full-suite tests, compilation, JavaScript syntax and a same-origin temporary-port Edge visual/keyboard/click/layer smoke passed. At the N4 checkpoint no canonical Location, provider reference, Event, journey or routing adapter was created; reviewed promotion and lists were subsequently delivered in N5A.
6. **Complete: N5A · Reviewed provider promotion and portable Map lists (2026-08-08).** Extended D02–D05/D19 with provider selection actions that remain non-mutating until a dedicated review confirms either one new canonical Location or one reviewed existing match. Exact provider identity, normalized name/address and 100-metre point evidence are shown together; linking existing accepts only a versioned neutral provider reference and never overwrites canonical assertions. New source-reported point/address assertions and every accepted reference are audited. Portable Favourites/named-list membership retains only provider/feature identity and a user-owned label, resolves current facts independently, exports as versioned JSON, survives whole-platform recovery and remains honestly unavailable through pack removal/version disappearance without silent reassignment or automatic WAN access. Migration `20260808_35_map_feature_lists`, two-version reconciliation/disappearance fixtures, fresh/upgrade/portability/HTTP coverage, all 346 tests, compilation, bundled-Node syntax and same-origin temporary-port Edge review/promotion/bookmark/revisit/keyboard/reflow checks passed. Coverage recommendations remain pending, so this completes N5A rather than N5.
