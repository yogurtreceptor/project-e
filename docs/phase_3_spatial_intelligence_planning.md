...
**Phase 3 is in progress, with implementation complete through N4 and the X1 prerequisite evidence complete.** N1, N2 and N3 were delivered and verified on 2026-08-05; X1 and N4 were completed on 2026-08-07. N5–N9 and L1–L3 remain planned, not delivered. Dated **Complete:** entries are delivered contracts or evidence; all other outcomes, ordering and candidates remain planning that does not authorise implementation or claim those capabilities exist.
...
| N5–N9 and L1–L3 | **Planned · not implemented** | Reviewed provider saving/lists, production journeys, Calendar materialisation and later spatial capabilities. |
...
| D19 | **N2/N4 Map-state subset resolved.** Last viewport, canonical and installed context-layer visibility, sidebar navigation and shared-place grouping are delivered. Recent-search/selection retention, named-list/favourite schema, provider-reference reconciliation and portability remain for N5 evidence. | Normal base, canonical Locations and available general-place/transit features begin visible; unavailable/specialist layers remain honest and choices persist locally. External bookmarks need no canonical promotion; user membership will be portable while provider facts are reacquired; no reusable saved journey. |
