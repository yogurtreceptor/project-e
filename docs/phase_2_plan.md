...
**Phase 2 — Planned.** Planned work is not delivered work. Phase 2 becomes **In progress** only when implementation is explicitly authorised. It becomes **Complete** only after the integrated completion review defined below; an isolated table, page, reminder, scheduled job or automation rule is not completion.
