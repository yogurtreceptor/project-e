...
| `/{domain}/{id}/delete` | Soft delete after native confirm and return to index | Inline form in index/header | Recoverable lifecycle is correct. Confirmation and action hierarchy are inconsistent with dedicated consequential flows. |
