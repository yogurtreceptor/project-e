...
- Read [the project goal](PROJECT_GOAL.md), the current phase documentation and [the contributor instructions](AGENTS.md). Phase 1 behaviour is recorded in the [Stage 1 specification](docs/stage_1_spec.md); current Phase 2 scope and exclusions are recorded in the [Phase 2 plan](docs/phase_2_plan.md).
