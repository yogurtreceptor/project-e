...
| 3 · Spatial Intelligence | In progress · N1–N6 + X1 complete | Canonical place, offline-first Map 2.0, provider-independent journey foundations, one verified installed Gold Coast map/search/context pack, reviewed provider/list/coverage workflows and trustworthy local walking journeys are delivered; public transport, Calendar materialisation, broader modes, travel-time and reachability tools remain planned. |
