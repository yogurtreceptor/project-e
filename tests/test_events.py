...
class EventServiceTests(unittest.TestCase):
    ...
    def test_calendar_originates_event_creation_and_editing(self) -> None:
        ...
        try:
            ...
            self.assertIn('id="my-calendars-title"><button class="calendar-sidebar-group-toggle"', page)
            self.assertIn('<span>My calendars</span></button>', page)
            self.assertIn('id="other-calendars-title"><button class="calendar-sidebar-group-toggle"', page)
            self.assertIn('<span>Other calendars</span></button>', page)
            self.assertEqual(2, page.count("data-calendar-group-toggle"))
            self.assertIn('href="/calendar/manage#add-calendar" aria-label="Create calendar"', page)
            ...
            self.assertIn('title="Coming soon!"', page)
    ...
    def test_calendar_visual_refinement_assets_preserve_view_state_and_scroll_boundaries(self) -> None:
        ...
        self.assertIn(".calendar-shell { grid-template-rows: 64px minmax(0, 1fr); height: 100dvh; overflow: hidden;", styles)
    ...
    def test_calendar_management_routes_use_calendar_services(self) -> None:
        ...
        try:
            ...
            self.assertIn('class="panel" id="add-calendar"', page)
            ...
            custom_settings = urlencode({"name": "Work", "colour": "#EF4444", "timezone": "Europe/London", "default_event_duration_minutes": "45", "sort_order": "2", "calendar_reminder_amount_0": "15", "calendar_reminder_unit_0": "m", "calendar_reminder_amount_1": "2", "calendar_reminder_unit_1": "h"})
            ...
            settings = urlencode({"name": "Work", "colour": "#EF4444", "timezone": "Europe/London", "default_event_duration_minutes": "45", "sort_order": "2"})
