...
ENTITY_DEFINITIONS: tuple[EntityDefinition, ...] = (
    ...
    EntityDefinition(
        ...
        table="locations",
        fields=(
            FieldDefinition("formatted_address", "Preferred physical address", multiline=True, optional=True, storage_kind="location_address"),
            FieldDefinition("address_line_1", "Address line 1", optional=True, storage_kind="location_address"),
            FieldDefinition("address_line_2", "Address line 2", optional=True, storage_kind="location_address"),
            FieldDefinition("suburb", "Suburb", optional=True, storage_kind="location_address"),
            FieldDefinition("city", "City", optional=True, storage_kind="location_address"),
            FieldDefinition("state", "State", optional=True, storage_kind="location_address"),
            FieldDefinition("post_code", "Post code", optional=True, storage_kind="location_address"),
            FieldDefinition("country", "Country", optional=True, storage_kind="location_address"),
            FieldDefinition(
                "address_confidence", "Address confidence", optional=True,
                options=("User confirmed", "Source reported", "Approximate", "Unknown"),
                default="User confirmed", storage_kind="location_address",
            ),
            FieldDefinition("address_source_name", "Address source", optional=True, storage_kind="location_address"),
            FieldDefinition("address_source_reference", "Address source reference", editable=False, overview=False, storage_kind="location_address"),
            FieldDefinition("address_source_version", "Address source version", editable=False, overview=False, storage_kind="location_address"),
            FieldDefinition("latitude", "Latitude", input_type="number", value_kind="latitude", optional=True, optional_group="coordinates", optional_group_label="Preferred representative point", storage_kind="location_geometry"),
            FieldDefinition("longitude", "Longitude", input_type="number", value_kind="longitude", optional=True, optional_group="coordinates", optional_group_label="Preferred representative point", storage_kind="location_geometry"),
            FieldDefinition(
                "geometry_confidence", "Geometry confidence", optional=True,
                options=("User confirmed", "Source reported", "Approximate", "Unknown"),
                default="User confirmed", storage_kind="location_geometry",
            ),
            FieldDefinition("accuracy_radius_metres", "Accuracy radius (metres)", input_type="number", optional=True, storage_kind="location_geometry"),
            FieldDefinition("geometry_source_name", "Geometry source", optional=True, storage_kind="location_geometry"),
            FieldDefinition("geometry_source_reference", "Geometry source reference", editable=False, overview=False, storage_kind="location_geometry"),
            FieldDefinition("geometry_source_version", "Geometry source version", editable=False, overview=False, storage_kind="location_geometry"),
        ),
