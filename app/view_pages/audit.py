...
def system_audit_page(events: list, filters: AuditFilters) -> str:
    event_options = _options(("create", "edit", "cancel", "reinstate", "reschedule", "archive", "unarchive", "delete", "restore", "permanent_delete", "merge", "validation", "inference", "import", "manual_override"), filters.event_type)
