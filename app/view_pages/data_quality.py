...
def data_quality_page(findings):
    ...
    return f'<section class="page-heading"><h1>Data Quality Centre</h1><p>Explainable findings derived from canonical graph data.</p></section><section class="panel"><table><thead><tr><th>Severity</th><th>Category</th><th>Explanation</th><th>Records</th><th>Status</th><th>Actions</th></tr></thead><tbody>{body}</tbody></table></section>'
