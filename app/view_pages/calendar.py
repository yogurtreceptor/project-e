...
def calendar_page(
    ...
    return f'''<div class="calendar-page"><div class="actions"><details class="action-menu calendar-create-menu"><summary class="button">Create<span class="menu-chevron" aria-hidden="true">▾</span></summary><div class="menu-panel"><ul><li><a href="/calendar/events/new" data-quick-create="event">Event</a></li><li><a href="/calendar/tasks/new" data-quick-create="task">Task</a></li></ul></div></details></div><div data-quick-create-root>{_quick_create_dialogs(calendars, task_lists)}</div>{projection}{created_notice}{task_notice}</div>'''
