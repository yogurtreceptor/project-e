...
Project E is a local-first Personal Information Platform for one private user. It stores canonical People, Organisations, Locations, Projects, Documents, Assets and Events; first-class Relationships; and local operational records such as Calendars, reminders and Inbox deliveries. Phases 1 and 2 are complete. Phase 3 spatial-intelligence delivery is in progress with N1–N4, the X1 Gold Coast prerequisite and N5A complete: the canonical place foundation, offline-first Map 2.0 workspace, provider-independent journey/profile/policy/cache foundation, verified replaceable Gold Coast local map/search/context pack, reviewed provider-to-Location promotion and portable external Map lists are current architecture. N5 coverage recommendations and N6 onward remain planned. Personal operational intelligence remains a longer-term direction.
...
- Phase 2's Calendar, Event, reminder, Inbox, scheduling and registered-automation behaviour remains current architecture. Phase 3 N1–N5A's canonical address/geometry/containment, offline-first Map 2.0, provider-independent journey/profile/policy/cache foundation, one-region verified spatial-pack lifecycle, reviewed provider promotion and portable Map-list behaviour are current architecture; X1's remaining routing front-runners are evidence only, and N5 coverage work plus N6 onward remain evolving desired state rather than an implementation checklist.
