...
Phases 1 and 2 are complete development milestones. Phase 2 delivered the local operational-time and deterministic-automation foundation: Calendar/Event, reminders, Inbox, scheduler and registered deterministic automation share validation, audit and provenance boundaries. Its earlier experimental Task subsystem was retired after it produced no useful user data; any future to-do or work-management capability requires a fresh, explicitly authorised design. Phase 2 remains human-first, database-first and AI-independent. AI, autonomous goal-directed workflows and autonomous external side effects remain later-phase capabilities; consequential mutations continue to require explicit user control. The [Phase 2 workspace](docs/phase_2_workspace.md) is the detailed delivery and closure record, while Phase 3 remains undefined until deliberately specified.
