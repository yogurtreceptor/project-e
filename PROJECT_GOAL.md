...
Phases 1 and 2 are complete development milestones. Phase 2 delivered the local operational-time and deterministic-automation foundation: Calendar/Event, reminders, Inbox, scheduler and registered automation share validation, audit and provenance boundaries. The earlier experimental Task subsystem was retired after it produced no useful user data; any future to-do or work-management capability requires a fresh, explicitly authorised design. Phase 3 planning now focuses on Spatial Intelligence: making place, geometry, movement, travel time and reachability useful across the existing canonical platform without turning replaceable map or routing data into a second source of truth. Consequential mutations continue to require explicit user control. The [Phase 2 workspace](docs/phase_2_workspace.md) records the completed milestone, and the [Phase 3 planning workspace](docs/phase_3_spatial_intelligence_planning.md) records the evolving direction without authorising implementation.
